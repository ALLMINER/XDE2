    ...
    nWeight(0)
{
	...
	//background-image: url(:/icons/overviewbg); background-repeat: no-repeat; background-position: top left;
	qApp->setStyleSheet("QMainWindow { background:black;font-family:'Open Sans,sans-serif';}");
